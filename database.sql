...
(1, 'shop_name', 'فروشگاه برادران نورزاد', '2025-09-05 13:38:39'),
...
(147, 'min_profit_margin', '5', '2025-09-05 13:38:39');
...
(1, '2d9bb11e98160d0fd2cf8448f20a47176da2dc07f50aee378bc99e811090f2df', '', 'active', '2025-09-05 15:34:39', '2026-09-05 15:34:39', 5, '[]', '2025-09-05 13:34:45', '2025-09-05 13:34:45');
...
INSERT INTO `transaction_types` (`id`, `type`, `name`, `created_at`) VALUES
(1, 'expense', 'کرایه', '2025-09-05 14:27:21'),
(2, 'expense', 'برق', '2025-09-05 14:27:21'),
(3, 'expense', 'آب', '2025-09-05 14:27:21'),
(4, 'expense', 'تلفن', '2025-09-05 14:27:21'),
(5, 'expense', 'حقوق', '2025-09-05 14:27:21'),
(6, 'expense', 'متفرقه', '2025-09-05 14:27:21'),
(7, 'withdrawal', 'برداشت شخصی', '2025-09-05 14:27:21'),
(8, 'withdrawal', 'سرمایهگذاری', '2025-09-05 14:27:21');
...
(10, 'manger', '$2y$10$OTecPVEakgTGKWoclm.dcOAUzIB7sLKFTd34PYuOmuHMrsbsgT93q', 'manger', 'manager', '2025-09-05 14:54:00');
...
--
ALTER TABLE `expense_transactions`
  ADD CONSTRAINT `expense_transactions_ibfk_1` FOREIGN KEY (`type_id`) REFERENCES `transaction_types` (`id`);
