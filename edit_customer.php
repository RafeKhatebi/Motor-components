                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="<?= sanitizeOutput($customer['name']) ?>" required>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            <label class="form-label">شماره تلفن</label>
                            <input type="text" name="phone" class="form-control" value="<?= sanitizeOutput($customer['phone']) ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group mb-3">
                    <label class="form-label">آدرس</label>
                    <textarea name="address" class="form-control" rows="3"><?= sanitizeOutput($customer['address']) ?></textarea>
                </div>
