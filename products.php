                ...
                <tbody>
                    <?php foreach ($products as $index => $product): ?>
                        <tr>
                            ...
                            <th scope="row">
                                <div class="media align-items-center">
                                    <div class="media-body">
                                        <span class="mb-0 text-sm"><?= sanitizeOutput($product['name']) ?></span><br>
                            ...
                            <td><?= number_format($product['sell_price']) ?>     <?= sanitizeOutput(__('afghani_currency')) ?>
                            </td>
                            <td>
                                <span class="badge badge-dot me-4">
                                    <i
                ...
                <nav aria-label="صفحه بندی">
                    <ul class="pagination justify-content-center mb-0">
                        ...
                        <?php if ($end < $total_pages): ?>
                            <?php if ($end < $total_pages - 1): ?>
                                <li class="page-item disabled"><span class="page-link">...</span></li><?php endif; ?>
                            <li class="page-item"><a class="page-link" href="?page=<?= $total_pages ?>"><?= $total_pages ?></a>
                            </li>
                        <?php endif; ?>
                    ...
                    <div class="text-center mt-3">
                        <small class="text-muted">
                            نمایش <?= sanitizeOutput($offset + 1) ?> تا
                            <?= sanitizeOutput(min($offset + $items_per_page, $total_items)) ?> از
    ...
    async function generateProductCode() {
        try {
            ...
            try {
                ...
                console.error('JSON Parse Error:', e);
                console.error('Response Text:', responseText);
                document.getElementById('productCode').value = '0001';
                return;
            }
