-- Backup created on 2025-08-20 11:07:55
...
-- Table: sales
DELETE FROM sales;
INSERT INTO sales (id, customer_id, total_amount, discount, final_amount, payment_type, paid_amount, remaining_amount, payment_status, created_at, status, return_reason, returned_at, returned_by) VALUES ('3', NULL, '440.00', '0.00', '440.00', 'credit', '0.00', '240.00', 'partial', '2025-08-17 17:35:23', 'completed', NULL, NULL, NULL);
