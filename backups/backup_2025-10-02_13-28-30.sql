-- Backup created on 2025-10-02 13:28:30
...
INSERT INTO categories (id, name, description, created_at) VALUES ('10', 'ئئئ', 'ددد', '2025-10-02 15:38:43');
...
INSERT INTO products (id, name, category_id, code, buy_price, sell_price, stock_quantity, min_stock, shelf_location, description, created_at) VALUES ('9', 'Ali', '9', '0006', '120.00', '200.00', '10', '5', '222', '', '2025-10-02 08:45:26');
...
INSERT INTO customers (id, name, phone, address, customer_type, created_at) VALUES ('5', 'Rafe Ahmad Khatebi', '0728958400', 'Herat, Afghanistan', 'wholesale', '2025-09-07 11:37:52');
...
INSERT INTO suppliers (id, name, phone, address, created_at) VALUES ('4', 'کمپنی', '0728958423', 'Herat, Afghanistan', '2025-10-02 15:57:27');
INSERT INTO suppliers (id, name, phone, address, created_at) VALUES ('5', 'سشسش', '0718958423', 'Herat, Afghanistan', '2025-10-02 15:57:36');

-- Table: sales
DELETE FROM sales;
INSERT INTO sales (id, customer_id, total_amount, discount, final_amount, payment_type, paid_amount, remaining_amount, payment_status, created_at, status, return_reason, returned_at, returned_by) VALUES ('3', NULL, '440.00', '0.00', '440.00', 'credit', '0.00', '40.00', 'partial', '2025-08-17 17:35:23', 'completed', NULL, NULL, NULL);
